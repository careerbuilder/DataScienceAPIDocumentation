...
| metropolitan_statistical_area | The metropolitan statistical area in which the location is. An object containing two fields, the title of the area and an integer code for the area. Metropolitan statistical areas are specific to the US. **This property may be absent**. |
