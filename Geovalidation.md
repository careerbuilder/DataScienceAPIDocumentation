...
| validation_strategies | Required. A comma-separated list of [Validation Strategies](#Validation Strategies) for making the geocoding request. |
| accepted_location_types | Required. A comma-separated list of [Location types](#Location types) to validate the geocoding response by. |
...
| metropolitan_statistical_area | The metropolitan statistical area in which the location is. Metropolitan statistical areas are specific to the US. **This property may be absent**. |
| designated_market_areas | The designated market area in which the location is. Designated market areas may overlap and thus a location may be in more than one designated market area. Designated market areas are specific to the continental US. **This property may be absent**. |
